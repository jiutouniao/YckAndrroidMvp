...
public class ScreenUtils {
    ...
    public static int getScreenWidth() {
        return AppContext.getmAppContext().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return AppContext.getmAppContext().getResources().getDisplayMetrics().heightPixels;
    }
    ...
    public static float dpToPx(float dp) {
        return dp * AppContext.getmAppContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / AppContext.getmAppContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / AppContext.getmAppContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * AppContext.getmAppContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    private int getStatusBarHeight() {
        ...
        try {
            ...
            sbar = AppContext.getmAppContext().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
        return sbar;
