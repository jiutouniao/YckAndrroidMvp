 ...
 * 通用公共输入框
 */
public class CommonClearEditText extends EditText implements OnFocusChangeListener, TextWatcher {
    /**
     * 删除按钮的引用
     */
...
//        	throw new NullPointerException("You can add drawableRight attribute in XML");
            mClearDrawable = getResources().getDrawable(R.drawable.icon_delte);
        }
    ...
    public void setOnTextChangeListener(OnTextChangeListener mListener){
