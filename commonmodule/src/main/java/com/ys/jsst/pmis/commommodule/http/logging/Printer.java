...
class Printer {
    ...
    static void printJsonRequest(LoggingInterceptor1.Builder builder, Request request) {
    ...
    static void printJsonResponse(LoggingInterceptor1.Builder builder, long chainMs, boolean isSuccessful,
    ...
    static void printFileRequest(LoggingInterceptor1.Builder builder, Request request) {
        String tag = builder.getTag(true);
        if (builder.getLogger() == null)
            I.log(builder.getType(), tag, REQUEST_UP_LINE);
        logLines(builder.getType(), tag, new String[]{URL_TAG + request.url()}, builder.getLogger(), false);
    ...
    static void printFileResponse(LoggingInterceptor1.Builder builder, long chainMs, boolean isSuccessful,
