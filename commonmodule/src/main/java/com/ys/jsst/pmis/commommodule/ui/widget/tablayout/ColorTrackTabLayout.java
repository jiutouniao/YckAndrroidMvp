package com.ys.jsst.pmis.commommodule.ui.widget.tablayout;
...
import com.ys.jsst.pmis.commommodule.util.ViewAttributeUtil;
    ...
    */
    ...
    public ColorTrackTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            //自定义属性的background
            mAttr_background = ViewAttributeUtil
